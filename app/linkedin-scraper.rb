    ...
    doc.css('ul.jobs-search__results-list > li').map do |job|
      {
        ...
        link: job.css('a.base-card__full-link').attr('href')&.value || nil,
        logo: job.css('div.search-entity-media img').attr('data-delayed-url')&.value || nil,
        company: job.css('h4.base-search-card__subtitle a').text.strip || nil,
        company_link: job.css('h4.base-search-card__subtitle a').attr('href')&.value || nil,
